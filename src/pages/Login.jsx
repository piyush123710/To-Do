              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required={isRegister}
                    className="w-full bg-slate-900/50 border border-slate-700 rounded-xl py-3 pl-11 pr-4 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all text-white"
